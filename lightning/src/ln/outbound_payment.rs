...
impl OutboundPayments {
	...
	#[rustfmt::skip]
	pub(super) fn send_spontaneous_payment_with_route<ES: Deref, NS: Deref, SP, L: Deref>(
		...
		L::Target: Logger,
	{
		let onion_session_privs = self.add_new_pending_payment(payment_hash,
			...
			.map_err(|_| {
				log_error!(logger, "Spontaneous payment with id {} is already pending. New payment had payment hash {}",
